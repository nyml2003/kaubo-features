...
用法:
    ...
    python3 ops/deploy/deploy.py 0.1.0
    python3 ops/deploy/deploy.py --root /srv/web
    python3 ops/deploy/deploy.py --repo owner/repo
...
NGINX_CONF_SRC = REPO_ROOT / "ops" / "deploy" / "nginx" / "kaubo.conf"
