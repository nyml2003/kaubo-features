...
fn encode_inline_caches(buf: &mut Vec<u8>, caches: &[crate::core::operators::InlineCacheEntry]) {
    ...
    match const_type {
        ...
        ConstantType::String => {
            ...
            *offset += 4;
            ...
            // 创建 ObjString
            let obj_string = crate::core::object::ObjString::new(s.to_string());
        ...
        ConstantType::List => {
            ...
            *offset += 4;
            ...
            // 创建 ObjList 并转换为指针
            let list = crate::core::object::ObjList::from_vec(elements);
...
fn decode_function_from_pool(
    ...
    use crate::core::object::ObjFunction;
...
fn decode_inline_caches(
    bytes: &[u8],
    offset: &mut usize,
) -> Result<Vec<crate::core::operators::InlineCacheEntry>, ChunkDecodeError> {
    if bytes.len() < *offset + 4 {
        return Err(ChunkDecodeError::TooShort);
    }
    ...
    *offset += 4;
    ...
    for _ in 0..len {
        ...
        *offset += 20;
        ...
        result.push(crate::core::operators::InlineCacheEntry {
            left_shape,
            right_shape,
...
mod tests {
    ...
    fn create_test_chunk() -> Chunk {
        ...
        // 添加一些字节码
        chunk.write_op(crate::core::bytecode::OpCode::LoadConst0, 1);
        chunk.write_op(crate::core::bytecode::OpCode::LoadConst1, 1);
        chunk.write_op(crate::core::bytecode::OpCode::Add, 1);
