...
use crate::compiler::parser::expr::{FunctionCall, Lambda};
use crate::compiler::parser::{Binary, Expr, ExprKind, TypeExpr};
use crate::core::{
...
fn compile_lambda(compiler: &mut Compiler, lambda: &Lambda) -> Result<(), CompileError> {
    ...
    // 编译函数体
    crate::runtime::compiler::stmt::compile_stmt(&mut function_compiler, &lambda.body)?;
