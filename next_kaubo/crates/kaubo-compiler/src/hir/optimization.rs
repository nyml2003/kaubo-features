...
fn fold_instruction(
    instr: &HirInstr,
    _constants: &[kaubo_ir::hir::ConstantValue],
) -> HirInstr {
    use kaubo_ir::hir::{ConstantValue as CV, HirBinaryOp, HirInstr as HI, HirOperand as HO};
...
use kaubo_ir::hir::{ConstantValue as CV, HirBinaryOp, HirInstr, HirOperand};
...
mod tests {
    ...
    use crate::hir::optimization::{ConstantFolding, PeepholeOptimizer, OptimizationPass, create_default_pipeline};
