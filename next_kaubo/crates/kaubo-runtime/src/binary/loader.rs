...
use kaubo_ir::{Chunk, VM, InterpretResult, ObjShape};
...
#[cfg(test)]
mod tests {
    use crate::binary::{BinaryWriter, WriteOptions, BuildMode, SectionKind, SectionData, ModuleEntry, BinaryWriter as _};
    use crate::binary::*;
