...
use crate::binary::header::{FileHeader, HeaderError, HEADER_SIZE};
use crate::binary::section::{SectionDirectory, SectionEntry, SectionError, SectionKind};
...
#[cfg(test)]
mod tests {
    use crate::binary::writer::{BinaryWriter, WriteOptions};
    use crate::binary::*;
