...
//!
//! ```rust,ignore
//! use crate::binary::{BinaryWriter, BinaryReader, WriteOptions, BuildMode};
//!
//! // 写入
...
pub mod data;
pub mod debug_info;
// mod e2e_tests; // needs orchestrator pipeline, skip
pub mod header;
pub mod loader;
pub mod reader;
pub mod section;
...
pub use header::{Arch, BuildMode, FeatureFlags, FileHeader, HeaderError, OS, HEADER_SIZE, MAGIC, VERSION_MAJOR, VERSION_MINOR};
