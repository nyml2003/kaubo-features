...
pub fn call_operator_closure_varargs(
    ...
    loop {
        ...
        match op {
            ...
            // 结构体
            BuildStruct => {
                let shape_id = super::execution::read_u16_at_ptr(ip);
                ip = unsafe { ip.add(2) };
                ...
                let obj = kaubo_ir::ObjStruct::new(shape_ptr, fields);
                let ptr = Box::into_raw(Box::new(obj));
                vm.stack.push(Value::struct_(ptr));
            }
