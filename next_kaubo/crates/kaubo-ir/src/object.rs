...
impl ObjFunction {
    pub fn new(chunk: Chunk, arity: u8, name: Option<String>) -> Self {
        Self { chunk, arity, name, ref_count: Cell::new(1) }
    }
}
...
impl ObjClosure {
    pub fn new(function: *mut ObjFunction) -> Self {
        Self { function, upvalues: Vec::new(), ref_count: Cell::new(1) }
    }
...
impl ObjString {
    pub fn new(chars: String) -> Self {
        Self { chars, ref_count: Cell::new(1) }
    }
}
...
impl ObjList {
    pub fn new() -> Self {
        Self { elements: Vec::new(), ref_count: Cell::new(1) }
    }

    pub fn from_vec(elements: Vec<Value>) -> Self {
        Self { elements, ref_count: Cell::new(1) }
    }
