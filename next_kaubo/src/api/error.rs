...
/// 词法错误（结构化）
pub use crate::core::kit::lexer::LexerError;

/// 语法错误（结构化）
pub use crate::core::compiler::parser::error::ParserError;
...
impl KauboError {
    /// 从 Compiler 错误转换
    fn from_compiler_error(e: crate::core::runtime::CompileError) -> Self {
        ...
        match self {
            ...
            KauboError::Parser(e) => {
                let (loc_type, line, col) = match &e.location {
                    crate::core::compiler::parser::error::ErrorLocation::At(coord) => {
                        ("at", Some(coord.line), Some(coord.column))
                    }
                    crate::core::compiler::parser::error::ErrorLocation::After(coord) => {
                        ("after", Some(coord.line), Some(coord.column))
                    }
                    crate::core::compiler::parser::error::ErrorLocation::Eof => ("eof", None, None),
                    crate::core::compiler::parser::error::ErrorLocation::Unknown => {
                        ("unknown", None, None)
                    }
                };
                ErrorReport {
